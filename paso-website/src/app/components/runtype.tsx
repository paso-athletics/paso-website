export default function Runtype(props : any) {
    let data = props.data;
    let videoBackground = data.bgType == 'video';
            ...
            <div className="absolute w-full p-4 vertical-align">
                <div>
                    ...
                    <div className="flex">
                        ...
                        <span className="ml-1">{`${data.time}`}</span>
                    </div>
                </div>
            </div>
        </div>
