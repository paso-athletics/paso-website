...
export default function Socials() {
    return (
        <div className='flex justify-center'>
            <a className='mx-2' href={`${SOCIAL_LINKS.instagram}`} target='_blank'>
            ...
            <a className='mx-2' href={`${SOCIAL_LINKS.tiktok}`} target='_blank'>
            ...
            <a className='mx-2' href={`${SOCIAL_LINKS.strava}`} target='_blank'>
                <svg className='h-4 w-4 hover:scale-[1.2]' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
                    <path fill="white" d="M6.731 0 2 9.125h2.788L6.73 5.497l1.93 3.628h2.766zm4.694 9.125-1.372 2.756L8.66 9.125H6.547L10.053 16l3.484-6.875z"/>
                </svg>
            </a>
            <a className='mx-2' href={`${SOCIAL_LINKS.whatsapp}`} target='_blank'>
                <svg className='h-4 w-4 hover:scale-[1.2]' xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
